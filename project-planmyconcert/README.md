...
## 📸 Screenshot Tampilan
### Beranda
![Beranda light](image/demolight-beranda.png)
![Beranda dark](image/demodark-beranda.png)

### Halaman Konser
![Konser light](image/demolight-konser.png)
![Konser dark](image/demodark-konser.png)

### Form Pemesanan
![Pemesanan light](image/demolight-pemesanan.png)
![Pemesanan dark](image/demodark-pemesanan.png)

### Halaman Konfirmasi
![Konfirmasi light](image/demolight-konfirmasi.png)
![Konfirmasi dark](image/demodark-konfirmasi.png)

### Blog & Artikel
![Blog light](image/demolight-blog.png)
![Blog dark](image/demodark-blog.png)

### FAQ
![FAQ light](image/demolight-FAQ.png)
![FAQ dark](image/demodark-FAQ.png)

### Tentang
![Tentang light](image/demolight-tentang.png)
![Tentang dark](image/demodark-tentang.png)

### Kontak
![Kontak light](image/demolight-kontak.png)
![Kontak dark](image/demodark-kontak.png)

### Ketentuan
![Ketentuan light](image/demolight-ketentuan.png)
![Ketentuan dark](image/demodark-ketentuan.png)
